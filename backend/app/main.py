...
from app.api.routes import auth, chat, documents, workspaces, admin, models as models_route
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description=(
            "State-of-the-art Retrieval-Augmented Generation platform with hybrid search, "
            "corrective RAG, multi-provider LLM support, workspace isolation, and RBAC."
        ),
        version="1.0.0",
        lifespan=lifespan,
        docs_url="/api/docs",
